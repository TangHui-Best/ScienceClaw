...
- Historical plan reference: `docs/superpowers/plans/2026-04-28-rpa-trace-first-full-migration.md` (not present in the current tree; retained as EV-001 history)
- Historical plan reference: `docs/superpowers/plans/2026-05-16-rpa-trace-source-final-convergence.md` (not present in the current tree; retained as EV-001 history)
