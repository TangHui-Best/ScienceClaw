...
ScienceClaw 是一款隐私优先的个人助手，具备 RPA（流程自动化）能力，基于 [LangChain DeepAgents](https://github.com/langchain-ai/deepagents) 架构与 [AIO Sandbox](https://github.com/agent-infra/sandbox) 基础设施构建。提供 1,900+ 内置工具、多格式文档生成、沙箱代码执行和浏览器自动化录制功能。
...
[产品优势](#why-scienceclaw) · [架构](#architecture) · [动态](#news) · [快速开始](#quick-start) · [本地配置](#local-setup) · [免费额度](#free-api-credits) · [工具与技能](#tools-skills) · [实用功能](#practical-features) · [项目结构](#project-structure) · [常用命令](#commands) · [社区](#community) · [致谢](#acknowledgements)
...
录制浏览器交互并自动生成 **Playwright 脚本**。ScienceClaw 捕获您的操作，生成智能定位器，创建可复用的自动化技能。支持 Docker 沙箱模式和本地模式，灵活部署。
...
ScienceClaw 集成了 **ToolUniverse**，提供 1,900+ 跨多个领域的工具，用于自动化、数据处理和 AI 驱动的工作流。
