...
from .asset_review import write_asset_review_packets
from .cli import emit_json_report


def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Generate RPA Harness asset review packets")
    ...
    report = write_asset_review_packets(args.assets, asset_ids=asset_ids)
